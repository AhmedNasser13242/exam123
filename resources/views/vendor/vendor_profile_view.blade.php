...
<div class="page-content">
    ...
    <div class="mb-3 page-breadcrumb d-none d-sm-flex align-items-center">
        <div class="breadcrumb-title pe-3">حساب المعلم</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="p-0 mb-0 breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">حساب</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                        ...
                        <div class="card-body">
                            <div class="text-center d-flex flex-column align-items-center">
                                <img src="{{ (!empty($vendorData->photo)) ? url('upload/vendor_images/'.$vendorData->photo):url('upload/no_image.jpg') }}"
                                    alt="Vendor" class="p-1 rounded-circle bg-primary" width="110">
                                <div class="mt-3">
                                    <h4>{{ $vendorData->name }}</h4>
                                    <p class="mb-1 text-secondary">{{ $vendorData->email }}</p>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-9 text-secondary">
                                        <select name="vendor_join" class="mb-3 form-select"
                                            ...
                                            <option selected="">اختر تاريخ</option>
