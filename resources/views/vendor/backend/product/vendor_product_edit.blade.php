						...
						<div class="col-lg-4">
							<div class="p-4 border rounded border-3">
								<div class="row g-3">
									...
									<div class="form-group col-12">
										<label for="inputProductType" class="form-label">Product Level</label>
										<select name="level_id" class="form-select" id="inputProductType">
											<option></option>
											@foreach($levels as $level)
											<option value="{{ $level->id }}" {{ $level->id == $products->level_id ?
												'selected' : '' }} >{{ $level->level_name }}</option>
											@endforeach
										</select>
									</div>
