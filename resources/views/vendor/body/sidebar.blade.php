    ...
    <div class="dlabnav-scroll">
        <ul class="metismenu" id="menu">
            <li><a class="has-arrow " href="javascript:void()" aria-expanded="false">
                    ...
                    <span class="nav-text">انشاء اختبار</span>
                </a>
                <ul aria-expanded="false">
                    <li><a href="{{ route('all.project') }}">جميع الاختبارات</a></li>
                    <li><a href="{{ route('add.project') }}">Dashboard Dark</a></li>
                </ul>
        ...
        <div class="side-bar-profile">
            ...
            <div class="mb-2 d-flex justify-content-between progress-info">
