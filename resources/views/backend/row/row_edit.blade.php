...
<div class="page-content">
    ...
    <div class="card">
        <div class="p-4 card-body">
            ...
            <form id="myForm" method="post" action="{{ route('update.row') }}">
                @csrf
                        ...
                        <div class="col-lg-8">
                            <div class="p-4 border rounded border-3">
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <input type="text" name="row_title" class="form-control" id="inputProductTitle"
                                        value="{{ $rows->row_title }}">
                                </div>
                                ...
                                <div class="row g-3">
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="category_id" class="form-select" id="inputVendor">
                                            ...
                                            <option value="{{ $cat->id }}" {{ $cat->id == $rows->category_id ?
                                    ...
                                    <div class="form-group col-12">
                                        ...
                                        <select name="subcategory_id" class="form-select" id="inputCollection">
                                            ...
                                            <option value="{{ $subcat->id }}" {{ $subcat->id == $rows->subcategory_id ?
                                    ...
                                    <div class="form-group col-12">
                                        <label for="inputrowType" class="form-label">المادة الدراسية</label>
                                        <select name="level_id" class="form-select" id="inputrowType">
                                            @foreach($levels as $level)
                                            <option value="{{ $level->id }}" {{ $level->id == $rows->level_id ?
                                                'selected' : '' }}>{{ $subcat->subcategory_name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group col-12">
                                        <label for="inputrowType" class="form-label">الوحدة الدراسية</label>
                                        <select name="brand_id" class="form-select" id="inputrowType">
                                            @foreach($brands as $brand)
                                            <option value="{{ $brand->id }}" {{ $brand->id == $rows->brand_id ?
                                    ...
                                    <div class="col-12">
                                        ...
                                        <select name="vendor_id" class="form-select" id="inputCollection">
                                            ...
                                            <option value="{{ $vendor->id }}" {{ $vendor->id == $rows->vendor_id ?
    ...
    <div class="page-content">
        ...
        <hr>
        <div class="card">
            <form method="post" action="{{ route('update.row.thambnail') }}" enctype="multipart/form-data">
                @csrf

                <input type="hidden" name="id" value="{{ $rows->id }}">
                <input type="hidden" name="old_img" value="{{ $rows->row_thambnail }}">

                <div class="card-body">
                    <div class="mb-3">
                        <label for="formFile" class="form-label">تغيير الصورة</label>
                        <input name="row_thambnail" class="form-control" type="file" id="formFile">
                    </div>


                    <div class="mb-3">
                        <label for="formFile" class="form-label"> </label>
                        <img src="{{ asset($rows->row_thambnail) }}" style="width:100px; height:100px">
                    </div>
            ...
            <div class="card-body">
                <table class="table mb-0 table-striped">
                    ...
                    <tbody>
                        ...
                        <form method="post" action="{{ route('update.row.multiimage') }}" enctype="multipart/form-data">
                            @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('row.multiimg.delete',$img->id) }}" class="btn btn-danger"
                                        id="delete"> مسح </a>
                                </td>
                            </tr>
                            @endforeach
    ...
    <script type="text/javascript">
        ...
        $('#myForm').validate({
            ...
            messages :{
                row_name: {
                    required : 'Please Enter row Name',
                },
                short_descp: {
                    required : 'Please Enter Short Description',
                },
                row_thambnail: {
                    required : 'Please Select row Thambnail Image',
                },
                multi_img: {
                    required : 'Please Select row Multi Image',
                },
                selling_price: {
                    required : 'Please Enter Selling Price',
                },
                row_code: {
                    required : 'Please Enter row Code',
                },
                 row_qty: {
                    required : 'Please Enter row Quantity',
                },
            },
            errorElement : 'span',
