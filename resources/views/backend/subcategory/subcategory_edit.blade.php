...
<div class="page-content">
	...
	<div class="mb-3 page-breadcrumb d-none d-sm-flex align-items-center">
		<div class="breadcrumb-title pe-3">تعديل الصفوف الدراسية</div>
		<div class="ps-3">
			<nav aria-label="breadcrumb">
				<ol class="p-0 mb-0 breadcrumb">
					<li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
					</li>
					<li class="breadcrumb-item active" aria-current="page">تعديل الصفوف الدراسية</li>
				</ol>
			</nav>
		</div>
		<div class="ms-auto">
					...
					<div class="card">
						<div class="card-body">
							...
							<form id="myForm" method="post" action="{{ route('update.subcategory') }}">
								...
								<div class="mb-3 row">
									<div class="col-sm-3">
										<h6 class="mb-0">اسم الصف الدراسي</h6>
									</div>
									<div class="form-group col-sm-9 text-secondary">
								...
								<div class="mb-3 row">
									...
									<div class="col-sm-9 text-secondary">
										<img id="showImage" src="{{ asset($subcategory->subcategory_image)   }}"
