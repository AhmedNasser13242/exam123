...
<div class="page-content">
    ...
    <div class="mb-3 page-breadcrumb d-none d-sm-flex align-items-center">
        <div class="breadcrumb-title pe-3">أضف سؤال اختياري</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="p-0 mb-0 breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">أضف سؤال اختياري</li>
                </ol>
            </nav>
        </div>
    ...
    <div class="card">
        <div class="p-4 card-body">
            ...
            <form id="myForm" method="post" action="{{ route('store.mcq') }}" enctype="multipart/form-data">
                @csrf
                        ...
                        <div class="col-lg-8">
                            <div class="p-4 border rounded border-3">
                                ...
                                <div class="mb-3 form-group">
                                    <label for="inputmcqTitle" class="form-label">رأس السؤال</label>
                                    <input type="text" name="mcq_title" class="form-control" id="inputmcqTitle"
                                ...
                                <div class="mb-3 form-group">
                                    ...
                                    <textarea name="first_answer" class="form-control" id="inputmcqDescription"
                                        rows="3"></textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="inputmcqDescription" class="form-label">الاجابة الثانية</label>
                                    <textarea name="sec_answer" class="form-control" id="inputmcqDescription"
                                        rows="3"></textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="inputmcqDescription" class="form-label">الاجابة الثالثة</label>
                                    <textarea name="thr_answer" class="form-control" id="inputmcqDescription"
                                        rows="3"></textarea>
                                </div>
                                <div class="mb-3 form-group">
                                    <label for="inputmcqDescription" class="form-label">الاجابة الرابعة</label>
                                    <textarea name="forth_answer" class="form-control" id="inputmcqDescription"
                                        rows="3"></textarea>
                                </div>

                                <div class="mb-3 form-group">
                                    <label for="inputmcqTitle" class="form-label">صورة السؤال اذا وجد</label>
