...
<div class="page-content">
    ...
    <div class="mb-3 page-breadcrumb d-none d-sm-flex align-items-center">
        <div class="breadcrumb-title pe-3">اضف المادة الدراسية</div>
        <div class="ps-3">
            <nav aria-label="breadcrumb">
                <ol class="p-0 mb-0 breadcrumb">
                    <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">اضف المادة الدراسية</li>
                </ol>
            </nav>
        </div>
        <div class="ms-auto">
                ...
                <div class="col-lg-10">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form id="myForm" method="post" action="{{ route('store.level') }}"
                                enctype="multipart/form-data"> @csrf
                                <div class="mb-3 row">
                                    <div class="col-sm-3">
                                        <h6 class="mb-0">اختيار الصف الدراسي</h6>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function (){
        $('#myForm').validate({
            ...
            messages :{
                level_name: {
                    required : 'Please Enter Levels Name',
                },
            },
            errorElement : 'span',
            errorPlacement: function (error,element) {
