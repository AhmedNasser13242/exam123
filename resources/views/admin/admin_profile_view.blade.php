...
<div class="page-content">
 	...
 	<img src="{{ (!empty($adminData->photo)) ? url('upload/admin_images/'.$adminData->photo):url('upload/no_image.jpg') }}" alt="Admin" class="p-1 rounded-circle bg-primary" width="110">
					<div class="mt-3">
						...
						<p class="text-muted font-size-sm">{{ $adminData->address }}</p>
										...
										<ul class="list-group list-group-flush">
											<li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
												...
												<span class="text-secondary">https://stylehavt.com</span>
											</li>

											<li class="flex-wrap list-group-item d-flex justify-content-between align-items-center">
												<h6 class="mb-0"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook me-2 icon-inline text-primary"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg>Facebook</h6>
												<span class="text-secondary">AhmedNasser1323</span>
											</li>
										</ul>
									</div>
								</div>
		...
		<form method="post" action="{{ route('admin.profile.store') }}" enctype="multipart/form-data" >
			...
			<div class="row">
				...
				<div class="col-sm-9 text-secondary">
					...
					<a href="{{ route('admin.profile') }}" class="px-4 btn btn-danger" value="cancel" >cancel</a>
				</div>
			</div>
		</div>
