...
class VendorProductController extends Controller
{
    ...
    public function VendorAddProduct(){
        ...
        return view('vendor.backend.product.vendor_product_add',compact('brands','categories','levels'));
 ...
 public function VendorGetSubCategory($category_id){
    ...
    public function VendorEditProduct($id){
        ...
        return view('vendor.backend.product.vendor_product_edit',compact('brands','categories', 'products','subcategory','multiImgs','levels'));
    }// End Method
