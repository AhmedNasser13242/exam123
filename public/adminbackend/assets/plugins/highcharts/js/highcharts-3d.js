...
(function(a) {
    ...
    function B(a, l, u, d) { a.hasOwnProperty(l) || (a[l] = d.apply(null, u)) }
    a = a ? a._modules : {};
    B(a, "Extensions/Math3D.js", [a["Core/Globals.js"], a["Core/Utilities.js"]], function(a, l) {
        var u = l.pick,
            d = a.deg2rad,
            m = a.perspective3D = function(d,
                k, h) { k = 0 < h && h < Number.POSITIVE_INFINITY ? h / (d.z + k.z + h) : 1; return { x: d.x * k, y: d.y * k } },
        ...
        a = a.shapeArea3d = function(d, a, h) { return k(w(d, a, h)) };
    ...
    B(a, "Core/Renderer/SVG/SVGRenderer3D.js", [a["Core/Color.js"], a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Renderer/SVG/SVGElement.js"], a["Core/Renderer/SVG/SVGRenderer.js"], a["Core/Utilities.js"]], function(a, l, u, d, m, w) {
        ...
        m.prototype.toLinePath = function(c, d) {
            var f = [];
            c.forEach(function(c) { f.push(["L", c.x, c.y]) });
        ...
        m.prototype.polyhedron = function(c) {
            ...
            f.faces = [];
            f.destroy = function() { for (var c = 0; c < f.faces.length; c++) f.faces[c].destroy(); return e.call(this) };
        ...
        a = {
            initArgs: function(c) {
                var g = this,
                    ...
                    d = e.zIndexes;
                g.parts.forEach(function(c) { g[c] = f.path(e[c]).attr({ "class": "highcharts-3d-" + c, zIndex: d[c] || 0 }).add(g) });
            ...
            processParts: function(g, e, f, d, b) {
                var x = this;
                x.parts.forEach(function(D) { e && (g = c(e[D], !1)); if (!1 !== g) x[D][f](g, d, b) });
                return x
            },
        ...
        var N = n(a, {
            ...
            fillSetter: function(c) {
                ...
                this.singleSetterForParts("fill", null, { front: c, top: G(c).brighten(0 <= this.forcedSides.indexOf("top") ? 0 : .1).get(), side: G(c).brighten(0 <= this.forcedSides.indexOf("side") ? 0 : -.1).get() });
        ...
        m.prototype.cuboid = function(c) { return this.element3d("cuboid", c) };
        m.prototype.cuboidPath = function(c) {
            function e(c) { return 0 === D && 1 < c && 6 > c ? { x: a[c].x, y: a[c].y + 10, z: a[c].z } : a[0].x === a[7].x && 4 <= c ? { x: a[c].x + 10, y: a[c].y, z: a[c].z } : 0 === v && 2 > c || 5 < c ? { x: a[c].x, y: a[c].y, z: a[c].z + 10 } : a[c] }

            function f(c) { return a[c] }
            var g = c.x,
                d = c.y,
                b = c.z || 0,
                D = c.height,
                ...
                a = [{
                    ...
                    y: d,
                    z: b
                }, { x: g + E, y: d, z: b }, { x: g + E, y: d + D, z: b }, { x: g, y: d + D, z: b }, { x: g, y: d + D, z: b + v }, { x: g + E, y: d + D, z: b + v }, { x: g + E, y: d, z: b + v }, { x: g, y: d, z: b + v }],
                q = [];
            ...
            return { front: this.toLinePath(c, !0), top: this.toLinePath(E, !0), side: this.toLinePath(z, !0), zIndexes: { group: Math.round(A) }, forcedSides: q, isFront: n, isTop: r }
        };
        m.prototype.arc3d = function(e) {
            ...
            f.onAdd = function() {
                var c = f.parentGroup,
                    e = f.attr("class");
                f.top.add(f);
                ["out", "inn", "side1", "side2"].forEach(function(d) { f[d].attr({ "class": e + " highcharts-3d-side" }).add(c) })
            };
            ["addClass", "removeClass"].forEach(function(c) {
                f[c] = function() {
                    var e = arguments;
                    ["top", "out", "inn", "side1", "side2"].forEach(function(d) { f[d][c].apply(f[d], e) })
                }
            });
            ...
            ["opacity", "translateX", "translateY", "visibility"].forEach(function(c) {
                f[c + "Setter"] = function(c, e) {
                    f[e] = c;
                    ["out", "inn", "side1", "side2", "top"].forEach(function(d) { f[d].attr(e, c) })
                }
            });
            f.attr = function(c) {
                var e;
            ...
            f.animate = function(e, g, a) {
                ...
                if (y.duration) {
                    ...
                    if (g) {
                        var k = g[0];
                        y.step = function(e, f) {
                            function d(e) { return v[e] + (c(k[e], v[e]) - v[e]) * f.pos }
        ...
        var w = l.perspective,
            ...
            n = function() {
                ...
                b.prototype.fix3dPosition = function(c, b) {
                    ...
                    "chart" !== q && ("flap" === q ? d.horiz ? (h = Math.sin(a), a = Math.cos(a), d.opposite && (h = -h), e && (h = -h), l = { x: g.z * h, y: a, z: -g.x * h }) : g = { x: Math.cos(h), y: 0, z: Math.sin(h) } : "ortho" === q ? d.horiz ? (l = Math.cos(a), q = Math.sin(h) * l, a = -Math.sin(a), h = -l * Math.cos(h), l = { x: g.y * h - g.z * a, y: g.z * q - g.x * h, z: g.x * a - g.y * q }, a = 1 / Math.sqrt(l.x *
                        l.x + l.y * l.y + l.z * l.z), e && (a = -a), l = { x: a * l.x, y: a * l.y, z: a * l.z }) : g = { x: Math.cos(h), y: 0, z: Math.sin(h) } : d.horiz ? l = { x: Math.sin(h) * Math.sin(a), y: Math.cos(a), z: -Math.cos(h) * Math.sin(a) } : g = { x: Math.cos(h), y: 0, z: Math.sin(h) });
                    c.x += p * g.x + m * l.x;
                    c.y += p * g.y + m * l.y;
                    c.z += p * g.z + m * l.z;
                    e = w([c], d.chart)[0];
                    b && (0 > G(w([c, { x: c.x + g.x, y: c.y + g.y, z: c.z + g.z }, { x: c.x + l.x, y: c.y + l.y, z: c.z + l.z }], d.chart)) && (g = { x: -g.x, y: -g.y, z: -g.z }), c = w([{ x: c.x, y: c.y, z: c.z }, { x: c.x + g.x, y: c.y + g.y, z: c.z + g.z }, { x: c.x + l.x, y: c.y + l.y, z: c.z + l.z }], d.chart), e.matrix = [c[1].x - c[0].x, c[1].y - c[0].y, c[2].x - c[0].x, c[2].y - c[0].y, e.x, e.y], e.matrix[4] -= e.x * e.matrix[0] + e.y * e.matrix[2], e.matrix[5] -= e.x * e.matrix[1] + e.y * e.matrix[3]);
                    return e
                };
                b.prototype.swapZ = function(c, d) { var b = this.axis; return b.isZAxis ? (d = d ? 0 : b.chart.plotLeft, { x: d + c.z, y: c.y, z: c.x - d }) : c };
                return b
            }();
        return function() {
            function a() {}
            ...
            a.onDestroy = function() {
                ["backFrame", "bottomFrame",
                    "sideFrame"
                ].forEach(function(c) { this[c] && (this[c] = this[c].destroy()) }, this)
            };
            a.onDrawCrosshair = function(c) { this.chart.is3d() && "colorAxis" !== this.coll && c.point && (c.point.crosshairPos = this.isXAxis ? c.point.axisXpos : this.len - c.point.axisYpos) };
            a.onInit = function() { this.axis3D || (this.axis3D = new n(this)) };
            a.wrapGetLinePath = function(c) { return this.chart.is3d() && "colorAxis" !== this.coll ? [] : c.apply(this, [].slice.call(arguments, 1)) };
            ...
            a.wrapGetPlotLinePath = function(c) {
                ...
                var k = e[0],
                    n = e[1];
                e = [];
                "M" === k[0] && "L" === n[0] && (d = [d.swapZ({ x: k[1], y: k[2], z: 0 }), d.swapZ({ x: k[1], y: k[2], z: h }), d.swapZ({ x: n[1], y: n[2], z: 0 }), d.swapZ({ x: n[1], y: n[2], z: h })], this.horiz ? (this.isZAxis ? (b.left.visible && e.push(d[0], d[2]), b.right.visible && e.push(d[1], d[3])) : (b.front.visible && e.push(d[0], d[2]), b.back.visible && e.push(d[1], d[3])), b.top.visible && e.push(d[0], d[1]), b.bottom.visible && e.push(d[2], d[3])) : (b.front.visible && e.push(d[0], d[2]), b.back.visible &&
            ...
            a.wrapGetTitlePosition = function(c) { var d = c.apply(this, [].slice.call(arguments, 1)); return this.axis3D ? this.axis3D.fix3dPosition(d, !0) : d };
            a.defaultOptions = {
    ...
    B(a, "Core/Axis/ZAxis.js", [a["Core/Axis/Axis.js"], a["Core/Utilities.js"]], function(a, l) {
        var u = this && this.__extends || function() {
            ...
            G = function() {
                ...
                a.wrapAddZAxis = function(d) { return new p(this, d) };
                return a
            }(),
            p = function(d) {
                function a(a, h) {
                ...
                a.prototype.getSeriesExtremes = function() {
                    ...
                    d.series.forEach(function(b) {!b.visible && a.options.chart && a.options.chart.ignoreHiddenSeries || (d.hasVisibleSeries = !0, b = b.zData, b.length && (d.dataMin = Math.min(w(d.dataMin, b[0]), Math.min.apply(null, b)), d.dataMax = Math.max(w(d.dataMax, b[0]), Math.max.apply(null, b)))) })
                };
    ...
    B(a, "Core/Chart/Chart3D.js", [a["Core/Axis/Axis.js"], a["Core/Axis/Axis3D.js"], a["Core/Chart/Chart.js"], a["Core/Globals.js"], a["Extensions/Math3D.js"],
        ...
        var B = k.isArray,
            ...
            A;
        (function(a) {
            function e(c) { this.is3d() && "scatter" === c.options.type && (c.options.type = "scatter3d") }
            ...
            function k() {
                if (this.chart3d && this.is3d()) {
                    ...
                    this.frameShapes || (this.frameShapes = { bottom: c.polyhedron().add(), top: c.polyhedron().add(), left: c.polyhedron().add(), right: c.polyhedron().add(), back: c.polyhedron().add(), front: c.polyhedron().add() });
                    this.frameShapes.bottom[v]({
                        "class": "highcharts-3d-frame highcharts-3d-frame-bottom",
                        zIndex: b.bottom.frontFacing ? -1E3 : 1E3,
                        faces: [{ fill: d.color(b.bottom.color).brighten(.1).get(), vertexes: [{ x: k, y: m, z: p }, { x: q, y: m, z: p }, { x: q, y: m, z: l }, { x: k, y: m, z: l }], enabled: b.bottom.visible }, { fill: d.color(b.bottom.color).brighten(.1).get(), vertexes: [{ x: e, y: h, z: a }, { x: f, y: h, z: a }, { x: f, y: h, z: 0 }, { x: e, y: h, z: 0 }], enabled: b.bottom.visible }, {
                    ...
                    this.frameShapes.top[v]({
                        ...
                        faces: [{ fill: d.color(b.top.color).brighten(.1).get(), vertexes: [{ x: k, y: n, z: l }, { x: q, y: n, z: l }, { x: q, y: n, z: p }, { x: k, y: n, z: p }], enabled: b.top.visible }, { fill: d.color(b.top.color).brighten(.1).get(), vertexes: [{ x: e, y: g, z: 0 }, { x: f, y: g, z: 0 }, { x: f, y: g, z: a }, { x: e, y: g, z: a }], enabled: b.top.visible }, {
                    ...
                    this.frameShapes.left[v]({
                        ...
                        faces: [{ fill: d.color(b.left.color).brighten(.1).get(), vertexes: [{ x: k, y: m, z: p }, { x: e, y: h, z: 0 }, { x: e, y: h, z: a }, { x: k, y: m, z: l }], enabled: b.left.visible && !b.bottom.visible }, { fill: d.color(b.left.color).brighten(.1).get(), vertexes: [{ x: k, y: n, z: l }, { x: e, y: g, z: a }, { x: e, y: g, z: 0 }, { x: k, y: n, z: p }], enabled: b.left.visible && !b.top.visible }, {
            ...
            function g() { this.is3d() && (this.isDirtyBox = !0) }

            function A() { this.chart3d && this.is3d() && (this.chart3d.frame3d = this.chart3d.get3dFrame()) }

            function f() { this.chart3d || (this.chart3d = new D(this)) }

            function u(c) { return this.is3d() || c.apply(this, [].slice.call(arguments, 1)) }
            ...
            var D = function() {
                ...
                c.prototype.get3dFrame = function() {
                    var c = this.chart,
                        ...
                        k = b.depth,
                        n = function(a) { a = h(a, c); return .5 < a ? 1 : -.5 > a ? -1 : 0 },
                    ...
                    var u = !1,
                        ...
                        w = !1,
                        G = !1;
                    [].concat(c.xAxis, c.yAxis, c.zAxis).forEach(function(c) { c && (c.horiz ? c.opposite ? F = !0 : u = !0 : c.opposite ? G = !0 : w = !0) });
                    var C = function(c, a, b) {
                        for (var d = ["size", "color", "visible"], e = {}, f = 0; f < d.length; f++)
                            for (var g = d[f], h = 0; h < c.length; h++)
                                if ("object" === typeof c[h]) { var k = c[h][g]; if ("undefined" !== typeof k && null !== k) { e[g] = k; break } }
                        c =
                            b;
                    ...
                    a = { axes: {}, bottom: C([a.bottom, a.top, a], m, u), top: C([a.top, a.bottom, a], l, F), left: C([a.left, a.right, a.side, a], v, w), right: C([a.right, a.left, a.side, a], r, G), back: C([a.back, a.front, a], n, !0), front: C([a.front, a.back, a], A, !1) };
                    "auto" === b.axisLabelPosition ? (r = function(c, a) { return c.visible !== a.visible || c.visible && a.visible && c.frontFacing !== a.frontFacing }, b = [], r(a.left,
                ...
                c.prototype.getScale = function(c) {
                    ...
                    [0, 1].forEach(function(c) { v.push({ x: d, y: v[c].y, z: v[c].z }) });
                    [0, 1, 2, 3].forEach(function(c) { v.push({ x: v[c].x, y: f, z: v[c].z }) });
                    v = p(v, a, !1);
            ...
            a.Composition = D;
            a.defaultOptions = { chart: { options3d: { enabled: !1, alpha: 0, beta: 0, depth: 100, fitToPlot: !0, viewDistance: 25, axisLabelPosition: null, frame: { visible: "default", size: 1, bottom: {}, top: {}, left: {}, right: {}, back: {}, front: {} } } } };
            a.compose = function(h, q) {
                var p = h.prototype;
                q = q.prototype;
                p.is3d = function() { return this.options.chart.options3d && this.options.chart.options3d.enabled };
    ...
    B(a, "Core/Series/Series3D.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Utilities.js"]], function(a, l, u) {
        ...
        l = u.addEvent;
        var m = u.pick;
        l(a.Series, "afterTranslate", function() { this.chart.is3d() && this.translate3dPoints() });
    ...
    B(a, "Series/Column3DSeries.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"],
        ...
        function G(a) { for (var b = [], c = 1; c < arguments.length; c++) b[c - 1] = arguments[c]; return this.series.chart.is3d() ? this.graphic && "g" !== this.graphic.element.nodeName : a.apply(this, b) }
        var p = l.perspective;
        l = d.addEvent;
        var h = d.pick;
        d = d.wrap;
        ...
        d(r.prototype, "justifyDataLabel", function(a) { return arguments[2].outside3dPlot ? !1 : a.apply(this, [].slice.call(arguments, 1)) });
        ...
        d(b.column.prototype, "animate", function(a) {
            if (this.chart.is3d()) {
                ...
                B && (b ? d.data.forEach(function(a) { null !== a.y && (a.height = a.shapeArgs.height, a.shapey = a.shapeArgs.y, a.shapeArgs.height = 1, h || (a.shapeArgs.y = a.stackY ? a.plotY + c.translate(a.stackY) : a.plotY + (a.negative ? -a.height : a.height))) }) : (d.data.forEach(function(a) {
        ...
        l(m.pie.prototype, "translate", function(a) {
            ...
            if (this.chart.is3d()) {
                ...
                k.data.forEach(function(a) {
                    ...
                    c.center = k.center;
                    c = (c.end + c.start) / 2;
                    a.slicedTranslation = { translateX: Math.round(Math.cos(c) * l.slicedOffset * Math.cos(b * d)), translateY: Math.round(Math.sin(c) * l.slicedOffset * Math.cos(b * d)) }
                })
            }
        });
        l(m.pie.prototype.pointClass.prototype, "haloPath", function(a) { var d = arguments; return this.series.chart.is3d() ? [] : a.call(this, d[1]) });
    ...
    B(a, "Series/Scatter3DSeries.js", [a["Core/Globals.js"], a["Extensions/Math3D.js"], a["Core/Series/Point.js"], a["Core/Utilities.js"]], function(a, l, u, d) {
        ...
        l("scatter3d", "scatter", { tooltip: { pointFormat: "x: <b>{point.x}</b><br/>y: <b>{point.y}</b><br/>z: <b>{point.z}</b><br/>" } }, {
            ...
            directTouch: !0
        }, { applyOptions: function() { u.prototype.applyOptions.apply(this, arguments); "undefined" === typeof this.z && (this.z = 0); return this } });
        ""
    });
    B(a, "Core/Axis/VMLAxis3D.js", [a["Core/Utilities.js"]], function(a) {
        var l = a.addEvent,
            u = function() { return function(a) { this.axis = a } }();
        return function() {
            function a() {}
            ...
            a.onInit = function() { this.vml || (this.vml = new u(this)) };
            a.onRender = function() {
                var a = this.vml;
